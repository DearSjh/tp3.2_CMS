			...
			<?php elseif(MODULE_NAME == 'Database'): ?>	
                ...
                <div id="Right">
                    <div class="contentArea">
	                    <div class="Item hr">
	                        <div class="current">修改后台入口</div>
	                    </div>
	                    <form action="" method="post">
	                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
	                            <tr>
	                                <th width="120">旧入口名：</th>
	                                <td><input name="old_admin_name" type="text" class="input" size="40" value="" /></td>
	                            	<td></td>
	                            </tr>
	                            <tr>
	                                <th width="120">新入口名：</th>
	                                <td><input name="new_admin_name" type="text" class="input" size="40" value="" /></td>
	                            	<td></td>
	                            </tr>
	                        </table>
	                    </form>
