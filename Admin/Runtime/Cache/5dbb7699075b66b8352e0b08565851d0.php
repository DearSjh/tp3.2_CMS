                ...
                <div id="Right">
                    <div class="Item hr">
	                    ...
	                    <div style="width: 100px;float: right;">
	                    	<a href="<?php echo U('Jkd/WebSite/tag_add');?>" class="btn" >添加标签</a>
	                    </div>
                    </div>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                        ...
                        <tbody>
                        	<?php if(is_array($tag_list)): foreach($tag_list as $key=>$jkd): ?><tr>
                        		<td align='center'><?php echo ($jkd["id"]); ?></td>
                        		<td align='center'><?php echo ($jkd["name"]); ?></td>
                        		<td align='center'><?php echo ($jkd["unique_id"]); ?></td>
                        		<td align='center'>
                        			<?php if($jkd['lang'] == 'zh-cn'): ?>简体中文<?php endif; ?>
                        			<?php if($jkd['lang'] == 'zh-en'): ?>English<?php endif; ?>
								</td>
                        		<td align='center'>
                        			<a href="<?php echo U('Jkd/WebSite/tag_edit', array('id' => $jkd['id']));?>" >编辑</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                        			<a link="<?php echo U('Jkd/WebSite/tag_del', array('id' => $jkd['id']));?>" href="javascript:void(0)" name="<?php echo ($jkd["name"]); ?>" class="del">删除</a>
                        		</td>
