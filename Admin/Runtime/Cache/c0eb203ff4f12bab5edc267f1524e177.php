                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                       	<tr>                                
                       		<td align="center" colspan='2'>
                       			<a href="<?php echo U('Jkd/Dev/admin_nav_list', array('cid' => 1));?>" class="btn submit">左侧导航（常规操作）</a>
                       		</td>
                       		<td align="center" colspan='2'>
                       			<a href="<?php echo U('Jkd/Dev/admin_nav_list', array('cid' => 2));?>" class="btn submit">头部导航</a>
                       		</td>
                    	</tr>
					</table>
                </div>
