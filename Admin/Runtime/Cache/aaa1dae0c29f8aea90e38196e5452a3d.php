...
<script type="text/javascript" src="__ROOT__/public/style/common/tips/asyncbox/asyncbox.js"></script>
    	...
    	<style type='text/css'> .tab td {padding:15px 10px;}</style>
    </head>
    <body>
        <div class="wrap">
            <!-- 公共头部 start -->
	...
	<div class="subMenuList">
		...
		<ul>
			...
			<?php elseif(MODULE_NAME == 'Database'): ?>	
                ...
                <div id="Right">
                    <div class="Item hr">
                        <div class="current">内容模型管理</div>
                    </div>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                       	<tr>                                
                       		<td align="center" colspan='4'>
                       			<a href="<?php echo U('Jkd/ArticleContentModel/article_model_list');?>" class="btn submit">文章模型</a>
                       		</td>
                       		<td align="center" colspan='4'>
                       			<a href="<?php echo U('Jkd/ProductContentModel/product_model_list');?>" class="btn submit">产品模型</a>
                       		</td>
                       		<td align="center" colspan='4'>
                       			<a href="<?php echo U('Jkd/PageContentModel/page_model_list');?>" class="btn submit">单页模型</a>
                       		</td>
                       		<td align="center" colspan='4'>
                       			<a href="<?php echo U('Jkd/Global/site_conf_model_list');?>" class="btn submit">站点配置模型</a>
                       		</td>
                       		<td align="center" colspan='4'>
                       			<a href="<?php echo U('Jkd/MessageContentModel/message_model_list');?>" class="btn submit">留言模型</a>
                       		</td>
                    	</tr>
					</table>
                </div>
