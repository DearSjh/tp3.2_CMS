	...
	<div class="subMenuList">
		...
		<ul>
			...
			<?php elseif(MODULE_NAME == 'Database'): ?>	
                ...
                <div id="Right">
                    <div class="Item">
                        <div class="current">轮播列表</div>
                        <div style="width: 100px;float: right;">
	                    	<a href="<?php echo U('Jkd/WebSite/banner_menu');?>" class="btn" >添加分类</a>
	                    </div>
                        <div style="width: 100px;float: right;">
	                    	<a href="<?php echo U('Jkd/WebSite/banner_add');?>" class="btn" >添加轮播</a>
	                    </div>
                    </div>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                        ...
                        <tbody>
                        	<?php if(is_array($ad_list)): foreach($ad_list as $key=>$jkd): ?><tr>
                        		...
                        		<td align='center'><?php echo ($jkd["title"]); ?></td>
                        		<td align='center'><?php echo ($jkd["menu_name"]); ?></td>
                        		<td align='center'><?php echo ($jkd["img_src"]); ?></td>
                        		<td align='center'>
                        			<a href="<?php echo U('Jkd/WebSite/banner_edit', array('id' => $jkd['id']));?>" >[编辑]</a>&nbsp;&nbsp;
                        			<a link="<?php echo U('Jkd/WebSite/banner_del', array('id' => $jkd['id']));?>" href="javascript:void(0)" name="<?php echo ($jkd["title"]); ?>" class="del">[删除]</a>
                        		</td>
