                ...
                <div id="Right">
                    <div class="Item">
                        ...
                        <div style="width: 100px;float: right;">
	                    	<a href="<?php echo U('Jkd/WebSite/ad_add');?>" class="btn" >添加广告</a>
	                    </div>
                    </div>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                        ...
                        <tbody>
                        	<?php if(is_array($ad_list)): foreach($ad_list as $key=>$jkd): ?><tr>
                        		<td align='center'><input type='text' class='input' name="sort[<?php echo ($jkd["id"]); ?>]" value="<?php echo ($jkd["sort"]); ?>" size='1' /></td>
                        		<td align='center'><?php echo ($jkd["ad_explain"]); ?></td>
                        		<td align='center'><?php echo ($jkd["ad_img_width"]); ?>x<?php echo ($jkd["ad_img_height"]); ?></td>
                        		<td align='center'><?php echo ($jkd["click"]); ?></td>
                        		<td align='center'>&#123;jkd_:get_ad('<?php echo ($jkd["id"]); ?>')&#125;</td>
                        		<td align='center'><?php echo ($jkd["ad_img_src"]); ?></td>
                        		<td align='center'>
                        			<a href="<?php echo C('site_url'); echo ($jkd["ad_img_src"]); ?>" target='_blank'>[预览]</a>&nbsp;&nbsp;
                        			<a href="<?php echo U('Jkd/WebSite/ad_edit', array('id' => $jkd['id']));?>" >[编辑]</a>&nbsp;&nbsp;
                        			<a link="<?php echo U('Jkd/WebSite/ad_del', array('id' => $jkd['id']));?>" href="javascript:void(0)" name="<?php echo ($jkd["ad_explain"]); ?>" class="del">[删除]</a>
                        		</td>
