                        	...
                        	<tr>
                                ...
                                <td>
                                    <select name="info[lang]">
                                        <option value="zh-cn" <?php if($tag_info['lang'] == 'zh-cn'): ?>selected<?php endif; ?> >简体中文</option>
                                        <option value="zh-en" <?php if($tag_info['lang'] == 'zh-en'): ?>selected<?php endif; ?> >English</option>
									</select>
                           		</td>
                            </tr>
                            <tr>
                                <th width="100">标签标题：</th>
                                <td><input id="title" type="text" class="input" size="60" name="info[name]" value="<?php echo ($tag_info["name"]); ?>"/></td>
                            </tr>
                            <tr>
                                <th>标签标识：</th>
                                <td><input type="text" class="input" size="40" name="info[unique_id]" value="<?php echo ($tag_info["unique_id"]); ?>"/> (英文字母)模版调用方法：<input type="text" value="<get_tag name='标识' />" disabled="" style="border: none"></td>
                            </tr>
                            <tr>
                                <th>标签内容：</th>
                                <td><textarea id="content" class="" style="height: 300px; width:80%;" name="info[content]"><?php echo ($tag_info['content']); ?></textarea></td>
                            </tr>
