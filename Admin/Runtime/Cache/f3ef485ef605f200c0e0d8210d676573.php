                ...
                <div id="Right">
                    <div class="Item hr">
	                    ...
	                    <div style="width: 100px;float: right;">
	                    	<button type="button" class="btn" onclick="window.location.href='<?php echo U('Jkd/MessageContentModel/message_model_add');?>'">添加字段</button>
	                    </div>
                    </div>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                        ...
                        <tbody>
                        	<?php if(is_array($message_extend_fields_list)): foreach($message_extend_fields_list as $key=>$jkd): ?><tr>
                        		...
                        		<td align='center'>
                        			<a href="<?php echo U('Jkd/MessageContentModel/message_model_edit', array('id' => $jkd['field_id']));?>" >编辑</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                        			<a link="<?php echo U('Jkd/MessageContentModel/message_model_del', array('field_name' => $jkd['field_name'],'id' => $jkd['field_id']));?>" href="javascript:void(0)" name="<?php echo ($jkd["form_explain"]); ?>" class="del">删除</a>
                        		</td>
