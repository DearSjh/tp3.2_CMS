			...
			<?php elseif(MODULE_NAME == 'Database'): ?>	
                ...
                <div id="Right">
                    <div class="contentArea">
	                    <div class="Item hr">
	                        <div class="current">系统配置</div>
	                    </div>
	                    <form action="" method="post">
	                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table1">
	                            <tr>
	                                <th width="120">是否开启手机站：</th>
	                                <td>
	                                	<input type='radio' value='1' name='is_mobile' <?php if(get_conf('is_mobile') == 1): ?>checked='checked'<?php endif; ?> />&nbsp;是&nbsp;&nbsp;
	                                	<input type='radio' value='0' name='is_mobile' <?php if(get_conf('is_mobile') == 0): ?>checked='checked'<?php endif; ?> />&nbsp;否
	                                </td>
	                            	<td></td>
	                            </tr>
	                            <tr>
	                                <th width="120">是否开启debug：</th>
	                                <td>
	                                	<input type='radio' value='1' name='is_debug' <?php if(get_conf('is_debug') == 1): ?>checked='checked'<?php endif; ?> />&nbsp;是&nbsp;&nbsp;
	                                	<input type='radio' value='0' name='is_debug' <?php if(get_conf('is_debug') == 0): ?>checked='checked'<?php endif; ?> />&nbsp;否
	                                </td>
	                            	<td></td>
	                            </tr>
	                        </table>
