		...
		<ul>
			...
			<?php elseif(MODULE_NAME == 'Database'): ?>	
                ...
                <div id="Right">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tab">
                       	<tr>                                
                       		<td align="left" colspan='4'>
		                    	<div class="jkd_info_t">您好，<?php echo $_SESSION['jkd_uname'] ?></div>  
                       			<span class='margin30'></span>&nbsp;&nbsp;&nbsp;
                       			您的上一次登录时间是：<?php echo $_SESSION['jkd_logintime'] ?><span class='margin30'>&nbsp;&nbsp;</span>
								您本次的登录时间是：<?php echo date('Y-m-d H:i'); ?>	<span class='margin30'>&nbsp;&nbsp;</span>
								您的上一次登录IP是：<?php echo $_SESSION['jkd_loginip'] ?><span class='margin30'>&nbsp;&nbsp;</span>
								您的本次登录IP是：<?php echo get_client_ip(); ?><span class='margin30'>&nbsp;&nbsp;</span>
                       		</td>
                    	</tr>
					</table>
					<!-- 官方动态加载 -->
					<iframe src="http://9kd.sk-school.com/9kd_common_admin/news.html" style='float:left;width:654px;height:265px;margin-top:15px;border:none;'></iframe>
					<!-- 官方动态加载  -->
                    <table style='float:left;margin-left:10px;' width="44%" border="0" cellspacing="0" cellpadding="0" class="tab" style='margin-top:0px;'>
                       	<tr>                            
                       		<td align="left" colspan='4'>
		                    	<div class="jkd_info_t">其他信息☑</div>  
		                    	<table class='jkd_table'>
									<tr>
										<td>9kd! CMS 程序版本</td>
										<td>9kd! CMS 1.0.0 beta 20140705&nbsp;&nbsp;&nbsp;&nbsp;<a href=''>9+雇佣兵</a> </td>
									</tr>
									<tr>
										<td>操作系统：</td>
										<td><?php echo ($server_info["a"]); ?></td>
									</tr>
									<tr>
										<td>主机名IP端口：</td>
										<td><?php echo ($server_info["b"]); ?></td>
									</tr>
									<tr>
										<td>运行环境：</td>
										<td><?php echo ($server_info["c"]); ?></td>
									</tr>
									<tr>
										<td>上传附件限制：</td>
										<td><?php echo ($server_info["d"]); ?></td>
									</tr>
								</table>
                			</td>
                    	</tr>
					...
					<!-- 官方开发团队 -->
					<iframe src="http://9kd.sk-school.com/9kd_common_admin/team.html" style='float:left;width:100%;height:215px;border:none;'></iframe>
					<!-- 官方开发团队 -->
                </div>
            </div>
        </div>
