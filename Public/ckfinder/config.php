...
*/
$baseUrl =dirname(dirname(dirname(dirname(dirname(dirname($_SERVER['PHP_SELF'])))))).'/Public/upload/image/';
...
/*$config['ResourceType'][] = Array(
		'name' => 'Common Files',				// Single quotes not allowed
		'url' => $baseUrl . 'image/files',
...
$config['ResourceType'][] = Array(
		'name' => 'friendlink',
		'url' => $baseUrl . 'friendlink',
		'directory' => $baseDir . 'friendlink',
		'maxSize' => 0,
		'allowedExtensions' => 'bmp,gif,jpeg,jpg,png',
		'deniedExtensions' => '');
...
$config['FilesystemEncoding'] = 'GB2312';
